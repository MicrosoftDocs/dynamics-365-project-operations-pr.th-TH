---
title: รายละเอียดส่วนหัวสำหรับสัญญาโครงการ
description: บทความนี้ให้ข้อมูลเกี่ยวกับฟิลด์และข้อมูลเกี่ยวกับสัญญาของโครงการใน Project Operations
author: rumant
ms.date: 03/08/2022
ms.topic: article
...
>[!NOTE]
>จำนวนเงินทั้งหมดบนแท็บ **ผลการดำเนินงานตามสัญญา** จะแสดงเป็นสกุลเงินเริ่มต้นของสภาพแวดล้อม

| ฟิลด์ | ตำแหน่ง | Description |
| --- | --- | --- |
