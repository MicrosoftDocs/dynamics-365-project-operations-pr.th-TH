...
- [จัดการคำขอของทรัพยากร](../project-service/manage-resource-requests.md) จับคู่ทักษะและความชำนาญของที่ปรึกษาของคุณไปยังโครงการที่เหมาะสม  
  
- [ดูความพร้อมใช้งานของทรัพยากร](../project-service/view-resource-availability.md) ตรวจสอบความพร้อมใช้งานของที่ปรึกษาในมุมมองปฏิทิน  
  
- [ดูการใช้ประโยชน์ของทรัพยากร](../project-service/view-resource-utilization.md) ดูเปอร์เซ็นต์ของเวลาที่ที่ปรึกษาของคุณถูกจองอยู่ในขณะนี้  
  
- [จัดกำหนดการทรัพยากรสำหรับโครงการ](../project-service/schedule-resources-project.md) จัดกำหนดการที่ปรึกษาสำหรับโครงการ  
  
  สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการส่งคำร้องขอทรัพยากรสำหรับแต่ละโครงการ ดู [ส่งคำขอทรัพยากร](../project-service/submit-resource-requests.md)  
