...
description: บทความนี้ให้ข้อมูลเกี่ยวกับวิธีการเพิ่ม การกำหนดค่า และการใช้ Add-in ของ Microsoft Project สำหรับ Project Service
author: ruhercul
ms.custom:
...
1.  จากแท็บ **Project Service** คลิก **อ่าน** > **เทมเพลต Project Service Automation**  

2.  เลือกเทมเพลตโครงการจากรายการ และจากนั้นคลิก **เปิด**  
...
1. จากแท็บ **Project Service** คลิก **เผยแพร่** > **เทมเพลตโครงการ Project Service Automation ใหม่**  
