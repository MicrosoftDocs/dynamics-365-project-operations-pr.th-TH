...
| การจัดส่งการปรับรุ่น | ระยะที่ 1 (มกราคม 2022) | ระยะที่ 2 (เวฟเดือนเมษายน 2022) | ระยะที่ 3 (เวฟเดือนเมษายน 2022) |
|------------------|------------------------|---------------------------|---------------------------|
...
ในฐานะส่วนหนึ่งของกระบวนการปรับรุ่น เราได้เพิ่มบันทึกการปรับรุ่นลงในแผนผังเว็บไซต์ เพื่อให้ผู้ดูแลระบบสามารถวินิจฉัยความล้มเหลวได้ง่ายขึ้น นอกเหนือจากส่วนติดต่อใหม่แล้ว เรายังได้เพิ่มกฎการตรวจสอบความถูกต้องใหม่เข้ามาเพื่อให้แน่ใจว่าข้อมูลมีความสมบูรณ์หลังจากการปรับรุ่น การตรวจสอบความถูกต้องที่มีการเพิ่มเข้าไปในกระบวนการปรับรุ่นมีดังต่อไปนี้

| การตรวจสอบความถูกต้อง | ระยะที่ 1 (มกราคม 2022) | ระยะที่ 2 (เวฟเดือนเมษายน 2022) | ระยะที่ 3 (เวฟเดือนเมษายน 2022) |
|-------------|------------------------|---------------------------|---------------------------|
...
| WBS จะได้รับการตรวจสอบกับขีดจำกัดที่ทราบของ Project Desktop Client | | :heavy_check_mark: | :heavy_check_mark: |
...
ในระยะที่ 2 ลูกค้าที่ปรับรุ่นเป็น Project Operations จะได้รับการปรับรุ่นโครงการที่มีอยู่ให้เป็นการทำงานแบบอ่านอย่างเดียวสำหรับการวางแผนโครงการ ในการทำงานแบบอ่านอย่างเดียวนี้ WBS ทั้งหมดจะมองเห็นได้ในตารางการติดตาม ในการแก้ไข WBS ผู้จัดการโครงการสามารถเลือก **แปลง** ในหน้า **โครงการ** หลัก กระบวนการแบบเบื้องหลังจะปรับปรุงโครงการเพื่อให้รองรับประสบการณ์การจัดกำหนดการโครงการแบบใหม่จาก Project for the Web ระยะนี้เหมาะสำหรับลูกค้าที่มีโครงการที่เข้าข่ายอยู่ใน [ขีดจำกัดที่ทราบของ Project for the Web](/project-for-the-web/project-for-the-web-limits-and-boundaries)
...
เพื่อให้มีสิทธิ์ได้รับการปรับรุ่นระยะที่ 1 ลูกค้าต้องมีคุณสมบัติตรงตามเกณฑ์ต่อไปนี้:

- สภาพแวดล้อมเป้าหมายต้องไม่มีเรกคอร์ดใดๆ ในเอนทิตี **msdyn_projecttask**
- ผู้ใช้ที่ใช้งานอยู่ทั้งหมดของลูกค้าต้องได้รับการกำหนดสิทธิ์การใช้งาน Project Operations ที่ถูกต้อง 
- ลูกค้าต้องตรวจสอบว่ากระบวนการปรับรุ่นในสภาพแวดล้อมที่ไม่ใช่การทำงานจริงอย่างน้อยหนึ่งรายการมีชุดข้อมูลตัวแทนซึ่งสอดคล้องกับข้อมูลการทำงานจริง
- สภาพแวดล้อมเป้าหมายต้องได้รับการปรับปรุงให้เป็น Project Service Automation Update Release 38 หรือใหม่กว่า

ข้อกำหนดเบื้องต้นสำหรับระยะที่ 2 และระยะที่ 3 จะได้รับการปรับปรุงเมื่อใกล้ถึงวันที่กำหนดความพร้อมใช้งานทั่วไป
...
## <a name="end-to-end-testing-in-lower-environments"></a>การทดสอบแบบครบวงจรในสภาพแวดล้อมที่ต่ำกว่า

### <a name="run-the-upgrade-in-production"></a>เรียกใช้การปรับรุ่นในการทำงานจริง
...
| การจัดการโครงการและการบัญชีของ Dynamics 365 Finance | การปรับใช้งาน Project Operations Lite                        | ยังไม่รองรับในขณะนี้ |
