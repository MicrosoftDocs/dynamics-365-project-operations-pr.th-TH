...
- หากคุณกำลังสร้างแม่แบบใหม่ คุณต้องเพิ่มคอลัมน์นี้ ใน Power Query ให้เลือก **เพิ่มคอลัมน์เงื่อนไข** และป้อนชื่อสำหรับคอลัมน์ใหม่ เช่น **ModelID** ป้อนเงื่อนไขสำหรับคอลัมน์ถ้างานโครงการไม่เป็น null ให้ \<ป้อนรหัสแบบจำลลองการคาดการณ์ \> ส่วนรายการอื่นเป็น null
...
[![การแม็ปแม่แบบ](./media/ProjectHourEstimatesMapping.jpg)](./media/ProjectHourEstimatesMapping.jpg)
...
- หากคุณกำลังสร้างแม่แบบใหม่ คุณต้องเพิ่มคอลัมน์นี้ ใน Power Query ให้เลือก **เพิ่มคอลัมน์เงื่อนไข** และป้อนชื่อสำหรับคอลัมน์ใหม่ เช่น **ModelID** ป้อนเงื่อนไขสำหรับคอลัมน์ ถ้ารายการประมาณการไม่เป็น null ให้ \<ป้อนรหัสแบบจำลลองการคาดการณ์\> ส่วนรายการอื่นเป็น null
...
[![การแม็ปแม่แบบ](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)

[![การแม็ปแม่แบบ](./media/ExpenseEstimatesMapping.jpg)](./media/ExpenseEstimatesMapping.jpg)
