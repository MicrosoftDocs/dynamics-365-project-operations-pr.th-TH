...
description: บทความนี้ให้ข้อมูลเกี่ยวกับการปรับมาตรฐานประสิทธิภาพของ API กำหนดการโครงการและระบุแนวทางปฏิบัติเพื่อการใช้งานที่เหมาะสมที่สุด
author: ruhercul
ms.date: 11/03/2021
ms.topic: article
...
บทความนี้ให้ข้อมูลเกี่ยวกับการปรับมาตรฐานประสิทธิภาพของ Application Programming Interface (API) กำหนดการโครงการและระบุแนวทางปฏิบัติเพื่อการใช้งานที่เหมาะสมที่สุด
...
API กำหนดการโครงการใช้บริการจัดกำหนดการโครงการเพื่อเรียกใช้คำขอที่จะอธิบายรายละเอียดเพิ่มเติมในส่วนต่อไปของบทความนี้
