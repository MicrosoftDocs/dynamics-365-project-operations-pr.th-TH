...
สามารถย้ายงานไปยังระดับใดก็ได้ในโครงสร้างการแบ่งงาน ด้วยหนึ่งในสองวิธีนี้:
...
## <a name="understanding-the-impacts-of-duration-resource-calendars-and-project-calendars-on-tasks"></a>ทำความเข้าใจผลกระทบของระยะเวลา ปฏิทินทรัพยากร และปฏิทินโครงการที่มีต่องาน
ระยะเวลาของงานถูกกำหนดเป็นจำนวนชั่วโมงทำงานระหว่างเวลาเริ่มต้นของวันที่เริ่มต้น และเวลาสิ้นสุดของวันที่สิ้นสุดของงาน   Project for the Web กำหนดหน่วยวัดระยะเวลาดังนี้:

| **การวัดของระยะเวลา** | **ปริมาณ**|
|----------------------------------------------------|----------------------|
| ชั่วโมงต่อวัน | 8 |
| ชั่วโมงต่อสัปดาห์ |  40 |
| วันต่อต่อเดือน |  20 |

งานที่ไม่ได้มอบหมายจะถูกจัดกำหนดการโดยใช้ปฏิทินของโครงการ อย่างไรก็ตาม เมื่อมีการมอบหมายทรัพยากรครั้งแรก การจัดกำหนดการของงานจะได้รับการอัปเดตเพื่อให้เป็นไปตามปฏิทินของทรัพยากร การเปลี่ยนแปลงในภายหลังของงานที่มีการมอบหมายจะถูกควบคุมโดย [โหมดการจัดกำหนดการ](scheduling-modes.md) ของโครงการ หากต้องการเรียนรู้เพิ่มเติมเกี่ยวกับอิทธิพลของปฏิทินที่มีต่องาน โปรดดูที่ [ปฏิทินทรัพยากรใน Project for the Web](https://techcommunity.microsoft.com/t5/project-blog/resource-calendars-in-project-for-the-web/ba-p/3269686) และ [เวลาเริ่มงานและโครงการของคุณ!](https://techcommunity.microsoft.com/t5/project-blog/task-start-times-amp-your-projects/ba-p/3269665)
