...
เมื่อ [คำขอรุ่นพรีวิว](https://forms.office.com/FormsPro/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR56j8lZs0FdAvwT75_WNFyxUMkRDV1NYQU5TNjE2VjhKOVBUNVg2R0s1NC4u) ของคุณได้รับการอนุมัติ คุณจะได้รับข้อเสนอสองรายการจาก Microsoft ทางอีเมล ข้อเสนอเหล่านี้ช่วยให้คุณสามารถปรับใช้งาน Project Operations รุ่นพรีวิว:

- Dynamics 365 Project Operations – การทดลองใช้รุ่นพรีวิว
- การทดลองใช้รุ่นพรีวิวของ Dynamics 365 for Finance and Operations
...
1. แลกรับข้อเสนอแรก **การทดลองใช้ Dynamics 365 Project Operations** ด้วย URL ที่ให้ไว้ในอีเมลต้อนรับของคุณ

![ข้อเสนอแรก](./media/1FirstOffer.png)

2. ตรวจสอบว่าคุณเข้าสู่ระบบในฐานะผู้ใช้ที่เป็นขององค์กรที่จะสมัครใช้บริการ
3. ดำเนินการแลกรับข้อเสนอต่อไป 
4. เลือก **ใช่ เพิ่มลงในบัญชีของฉัน**
...
ทำตามขั้นตอนเดิมซ้ำสำหรับข้อเสนอที่สองจากอีเมลต้อนรับ
...
3. ตรวจสอบว่าได้เลือกสิทธิ์การใช้งาน Project Operations แล้ว และเลือก **บันทึกการเปลี่ยนแปลง** 
