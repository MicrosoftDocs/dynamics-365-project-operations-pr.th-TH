...
description: หัวข้อนี้อธิบายวิธีใช้แนวคิดของที่มาของธุรกรรมเพื่อเชื่อมโยงข้อมูลจริงกับเรกคอร์ดต้นทางเดิม เช่น รายการเวลา รายการค่าใช้จ่าย หรือบันทึกการใช้วัสดุ
author: rumant
ms.date: 03/25/2021
ms.topic: article
ms.prod: ''
