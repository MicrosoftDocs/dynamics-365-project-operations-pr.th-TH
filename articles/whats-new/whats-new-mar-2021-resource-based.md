---
title: มีอะไรใหม่เดือนมีนาคม 2021 - Project Operations สำหรับสถานการณ์ตามทรัพยากร/ไม่ได้เก็บในคลัง
description: บทความนี้ให้ข้อมูลเกี่ยวกับการปรับปรุงคุณภาพที่มีอยู่ใน Project Operations ประจำเดือนมีนาคม 2021 สำหรับสถานการณ์ตามทรัพยากร/ไม่ได้เก็บในคลัง
author: sigitac
ms.date: 03/03/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9028438"
---
# <a name="whats-new-march-2021---project-operations-for-resourcenon-stocked-based-scenarios"></a>มีอะไรใหม่เดือนมีนาคม 2021 - Project Operations สำหรับสถานการณ์ตามทรัพยากร/ไม่ได้เก็บในคลัง
...
| การวางแผนและการติดตาม | 2125274 | แอตทริบิวต์ **แมปการรวมแบบสองทิศทางของโครงการ** สำหรับ **การแมปวันที่เริ่มโครงการ** ที่ปรับปรุงจาก **msdyn\_taskearlieststart** เป็น **msdyn\_actualstart** |
...
สำหรับข้อมูลเพิ่มเติม โปรดดู [มีอะไรใหม่เดือนมกราคม 2021 - Project Operations fสำหรับสถานการณ์ตามทรัพยากร/ไม่ได้เก็บในคลัง](whats-new-jan-2021-resource-based.md)
